...
echo '<form id="myform" action="update.php?q=quiz&step=2&eid='.$eid.'&n='.$sn.'&t='.$total.'&qid='.$qid.'" method="POST"  class="form-horizontal">
<br />';
...
echo'<br /><button type="submit" id = "ff" name="submit" class="btn btn-primary"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span>&nbsp;Next</button></form></div>';
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/mvgr.jpeg" width=100 height=100 alt="MVGR" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Jhansi Rani</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">Deepak</h4>
		<h4 style="font-family:'typo' ">Sai Kumar</h4>
    <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">Hemanth</h4></h4>
		<h4 style="font-family:'typo' ">@ Beulah Rani Mam</h4></div></div>
		</p>
      </div>
